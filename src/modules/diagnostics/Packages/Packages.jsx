    ...
    <>
      <div className="px-24 flex flex-col bg-gradient-to-b from-[#fbe5d8] to-white ">
        <div className="flex justify-between items-baseline">
          <p className="text-primary-solid text-4xl pt-4">
        ...
        <div className="flex flex-col gap-4 ">
          <div className="flex   gap-5 mt-10">
            ...
            <button className="flex justify-center items-center flex-grow-0 flex-shrink-0 h-11 relative gap-2.5 px-5 py-2.5 rounded-[30px] bg-[#e77e3a]">
          ...
          <div>
            <p className=" flex-grow-0 flex-shrink-0  text-xl font-semibold  text-[#656565]">
              ...
              eiusmod tempor incididunt ut bore et dolore magna aliqua. Ut enim
      ...
      <div className="px-24">{!isSlider && <PackageList />}</div>
      <div className="px-24">{isSlider && <PackageSlider />}</div>
      <div className="flex justify-center my-10">
        <button
          onClick={handleExpandButton}
          className="flex justify-start items-center flex-grow-0 flex-shrink-0 h-10 relative gap-2.5 px-5 py-[7px] rounded-[30px] bg-white border border-[#e77e3a]"
        >
